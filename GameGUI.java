...
public class GameGUI {
        ...
        private void drawHealthBar(Graphics2D g) {
                ...
                Shape rectangle2Fill = new RoundRectangle2D.Double(
                                healthBar2Location.getX() + healthBarXSize - (t2Health * 2), healthBar2Location.getY(),
                                t2Health * 2, healthBarYSize, 40, 40);
                ...
                Shape rectangle3Fill = new RoundRectangle2D.Double(powerBar1Location.getX(),
                                powerBar1Location.getY() + powerBarYSize - (t1Power - 1), powerBarXSize, t1Power, 20,
                                20);
                Shape rectangle4Fill = new RoundRectangle2D.Double(powerBar2Location.getX(),
                                powerBar2Location.getY() + powerBarYSize - (t2Power - 1), powerBarXSize, t2Power, 20,
                                20);
